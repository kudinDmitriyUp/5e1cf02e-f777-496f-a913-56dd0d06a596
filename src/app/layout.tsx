...
export const metadata: Metadata = {
  title: "The Techshop - Venture Capital for B2B Digital Ventures",
  description: "Patient and active capital for early-stage B2B digital ventures. Strategic partnership, hands-on support, and proven expertise in scaling technology companies.",
  keywords: "venture capital, B2B, early-stage startups, seed funding, tech investment, portfolio companies",
  metadataBase: new URL("https://techshop.capital"),
  alternates: {
    canonical: "https://techshop.capital"
  },
  openGraph: {
    title: "The Techshop - Venture Capital Partners",
    description: "Strategic capital and active support for the best early-stage ventures in the B2B digital space",
    url: "https://techshop.capital",
